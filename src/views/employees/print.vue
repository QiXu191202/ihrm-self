    ...
    <div class="app-container">
      <el-card>
        ...
        <el-row type="flex" justify="end">
          <el-button v-print="'#box'" size="small" type="primary"
            >打印</el-button
          >
        </el-row>
        <!-- 个人详情 -->
        <div v-if="type === 'personal'" id="box">
...
<script>
import { getEmployeeInfoApi, getJobInfoApi } from "@/api/employees";
...
export default {
  ...
  methods: {
    async getPersonalDetail() {
      this.formData = await getEmployeeInfoApi(this.userId); // 获取个人基本信息
    },
    async getJobDetail() {
